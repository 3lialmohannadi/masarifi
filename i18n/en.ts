export const en = {
  ...
  commitments: {
    ...
    reminderToggle: "Remind 1 day before",
    reminderDesc: "Send a notification one day before due date",
  },
  statistics: {
    title: "Statistics",
    ...
    trendTitle: "Trends (6 Months)",
    forecastCard: "Spending Forecast",
    forecastLabel: "Forecasted",
    forecastHigher: "Higher than last month",
    savingsRate: "Savings Rate",
    savingsRateOf: "of income saved",
    vsLastMonth: "vs last month",
    noForecast: "No data for forecast",
  ...
  settings: {
    ...
    notifPermDenied: "Denied — tap to open settings",
    notifPermUndetermined: "Permission not requested yet",
  ...
  auth: {
    ...
    greetingSub: "Here's your financial overview",
