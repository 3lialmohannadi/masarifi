export const ar = {
  ...
  categories: {
    ...
    budgetSet: "تعيين ميزانية شهرية",
    budgetAmount: "مبلغ الميزانية الشهرية",
    budgetDelete: "إزالة الميزانية",
    budgetSaved: "تم حفظ الميزانية",
    budgetDeleted: "تمت إزالة الميزانية",
    budgetOf: "من",
    budgetSpent: "مُصرف",
  },
  savings: {
  ...
  commitments: {
    ...
    reminderToggle: "تذكير قبل يوم",
    reminderDesc: "إشعار قبل تاريخ الاستحقاق بيوم",
  },
  statistics: {
    title: "الإحصائيات",
    ...
    trendTitle: "الاتجاهات (٦ أشهر)",
    forecastCard: "توقع الإنفاق",
    forecastLabel: "متوقع",
    forecastHigher: "أعلى من الشهر الماضي",
    savingsRate: "معدل الادخار",
    savingsRateOf: "من الدخل مدخر",
    vsLastMonth: "مقارنة بالشهر الماضي",
    noForecast: "لا توجد بيانات للتوقع",
    incomeVsExpenseTrend: "اتجاه الدخل والمصروف",
  },
  settings: {
    title: "الإعدادات",
    language: "اللغة",
    ...
    notifPermGranted: "مفعّل",
    notifPermDenied: "محظور — انقر للإعدادات",
    notifPermUndetermined: "لم يُطلب الإذن بعد",
  ...
  onboarding: {
    slide1Title: "مرحباً بك في مصاريفي",
    slide1Subtitle: "تطبيقك الشخصي لإدارة ماليتك بسهولة وذكاء",
    slide2Title: "تتبّع كل شيء",
    slide2Subtitle: "سجّل دخلك ومصروفاتك وادخارك في مكان واحد",
    slide3Title: "خصّص تجربتك",
    slide3Subtitle: "اختر لغتك وعملتك المفضلة",
    slide4Title: "أنت جاهز!",
    slide4Subtitle: "ابدأ رحلتك نحو إدارة مالية أفضل الآن",
    start: "ابدأ الآن",
    next: "التالي",
    skip: "تخطي",
    language: "اللغة",
    currency: "العملة",
    feature1Title: "الحسابات",
    feature1Desc: "تتبّع أرصدة جميع حساباتك والمحافظ",
    feature2Title: "المعاملات",
    feature2Desc: "سجّل مصروفاتك ودخلك مع تصنيفات ذكية",
    feature3Title: "الادخار",
    feature3Desc: "ضع أهدافاً للادخار وتابع تقدمك",
  },
  auth: {
    signIn: "تسجيل الدخول",
    signUp: "إنشاء حساب",
    ...
    greetingSub: "إليك ملخص أموالك اليوم",
