export const ar = {
  ...
  plans: {
    ...
    edit: "تعديل الخطة",
    delete: "حذف الخطة",
    deleteConfirm: "هل تريد حذف هذه الخطة؟",
    budget: "الميزانية",
    spent: "المصروف",
    remaining: "المتبقي",
    usage: "نسبة الاستخدام",
    categories: "فئات الخطة",
    addCategory: "إضافة فئة",
    editCategory: "تعديل الفئة",
    deleteCategory: "حذف الفئة",
    startDate: "تاريخ البداية",
    endDate: "تاريخ النهاية",
    transactions: "عمليات الخطة",
    noPlans: "لا توجد خطط",
    addFirstPlan: "أنشئ خطة للادخار من أجل أهدافك",
  ...
  budget: {
    ...
    deleteConfirm: "هل تريد حذف هذه الميزانية؟",
    limitAmount: "حد الميزانية",
    amount: "المبلغ المخطط",
    spent: "المصروف",
    remaining: "المتبقي",
    usage: "نسبة الاستهلاك",
    month: "الشهر",
    year: "السنة",
    noBudgets: "لا توجد ميزانيات",
    addFirstBudget: "أضف ميزانية لكل تصنيف لتتبع إنفاقك",
  ...
  settings: {
    ...
    resetConfirmMessage: "سيتم حذف جميع الحسابات والعمليات والمحافظ الادخارية والالتزامات والخطط والميزانيات بشكل نهائي.\n\nلا يمكن التراجع عن هذا الإجراء.",
