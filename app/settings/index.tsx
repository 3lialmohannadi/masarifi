...
function SectionLabel({ title }: { title: string }) {
  ...
  return (
    <Text style={{ fontSize: 12, fontWeight: "700", color: theme.textSecondary, textAlign: isRTL ? "right" : "left", paddingHorizontal: 4, marginBottom: 6, marginTop: 8, letterSpacing: 0.3 }}>
      {title}
    </Text>
  );
}
