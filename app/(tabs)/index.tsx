    ...
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        >
          <View style={{ gap: 5 }}>
            <Image
              source={isDark ? (language === "ar" ? require("@/assets/logo_ar_dark.png") : require("@/assets/logo_transparent.png")) : language === "ar" ? require("@/assets/logo_ar_light.png") : require("@/assets/logo.png")}
              resizeMode="contain"
